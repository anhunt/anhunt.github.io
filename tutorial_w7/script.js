...
function createMyMap() {
    ...
    try {
        ...
        restaurants.forEach(function(restaurant, index) {
            ...
            // Build popup content using restaurant.name, restaurant.cuisine, restaurant.rating
            const popupContent = `<strong>${restaurant.name}</strong><br>
