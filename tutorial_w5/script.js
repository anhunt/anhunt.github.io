...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    displayButton.addEventListener('click', () => {
        ...
        restaurants.forEach( (restaurant)=> {
            ...
            restaurantList.innerHTML += `
            <div><strong>${restaurant.name}</strong> ${cuisine}</div>`;
    ...
    filterButton.addEventListener('click', (event) =>{
        ...
        cheapRestaurants.forEach((restaurant) => {
            filteredList.innerHTML +=
            `<div><strong>${restaurant.name}</strong> ${restaurant.cuisine}</div>`;
        });
    ...
    findButton.addEventListener('click', (event) =>{
        ...
        if (bestRestaurant) {
            foundItem.innerHTML = `
            <div><strong>${bestRestaurant.name}</strong> - ${bestRestaurant.cuisine} - Rating: ${bestRestaurant.rating}</div>`;
        } else {
