...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadButton.addEventListener('click', async function() {
        ...
        try {
            ...
            statusMessage.textContent = `Failed! Try again: ${error.message}`;
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach(function(restaurant) {
            ...
            item.textContent = `${restaurant.name} - ${restaurant.cuisine} - $${restaurant.priceRange}`;
...
filterButton.addEventListener('click', function() {
    ...
    const cheapRestaurants = restaurants.filter(function(restaurant) {
        const price = restaurant.priceRange.trim();
        return price === '$' || price === '$$';
    });
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // YOUR CODE HERE:
            errorDisplay.innerHTML = '<div class="status-display error"><p class="status-message">Failed to load data. URL bad!!</p></div>';
